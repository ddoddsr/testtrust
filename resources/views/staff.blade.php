        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col">
                ...
                <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                    <h1 class="sm:w-2/5 text-gray-900 font-medium title-font text-2xl mb-2 sm:mb-0">The IHOPKC Community</h1>
                    <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">exists to partner in the Great Commision by Advancing 24/7prayer and by proclaiming the beauty of Jesus and His glorious return.</p>
                </div>
            </div>
            <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
                ...
                <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
                    ...
                    <p class="text-base leading-relaxed mt-2">Sacred Trust is rigiourious enough without have difficult computers to deal with.</p>
                    <x-learn-more />
                </div>
                <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
                    <div class="rounded-lg h-64 overflow-hidden">
